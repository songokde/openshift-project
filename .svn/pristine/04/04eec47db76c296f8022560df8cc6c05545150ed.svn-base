...
public class ShyyConstant {
	...
	public static  Map<Integer,String> methodMap =new HashMap<>();
	static {
		methodMap.put(0, "web");
		methodMap.put(1, "cc");
		methodMap.put(2, "visit");
	}
	
	public static  Map<Integer,String> requestTypeMap =new HashMap<>();
	static {
		requestTypeMap.put(0, "post");
		requestTypeMap.put(1, "get");
		requestTypeMap.put(2, "other");
	}
	...
	public final static String REDIS_KEY_DOMAIN = "domain";
